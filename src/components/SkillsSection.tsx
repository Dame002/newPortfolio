    ...
    <section id="skills" className="relative py-20 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(180 80% 60% / 0.4), transparent 70%)",
            left: "15%",
            top: "15%",
          }}
          animate={{
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(200 100% 50% / 0.3), transparent 70%)",
            right: "10%",
            bottom: "10%",
          }}
          animate={{
            ...
            <div className="relative holo-border holo-glow rounded-xl overflow-hidden scanline">
              ...
              <div className="p-6 bg-background/90 backdrop-blur-sm">
                <div className="relative">
                  ...
                  {skillCategories.map((category, catIdx) => (
                    ...
                    >
                      ...
                      <div className="code-line">
                        <span className="line-number relative z-10">
                          {String(catIdx * 3 + 2).padStart(2, "0")}
                        </span>
                        <span className="ml-4">
                      ...
                      <div className="code-line">
                        <span className="line-number relative z-10">
                          {String(catIdx * 3 + 3).padStart(2, "0")}
                        </span>
                          ...
                          {category.skills.map((skill, i) => (
                            ...
                            >
                              ...
                              {i < category.skills.length - 1 && (
                                <span className="syntax-operator ml-0.5">
                                  ,
                                </span>
                              )}
                            </motion.span>
                      ...
                      <div className="code-line">
                        <span className="line-number relative z-10">
                          {String(catIdx * 3 + 4).padStart(2, "0")}
                        </span>
                        <span className="ml-4">
                  ...
                  <div className="code-line">
                    <span className="line-number relative z-10">
                      {String(skillCategories.length * 3 + 2).padStart(2, "0")}
                    </span>
                    <span className="ml-4">
                      <span className="syntax-operator">{"}"}</span>
                    </span>
